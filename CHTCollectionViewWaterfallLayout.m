...
NSString *const CHTCollectionElementKindSectionDecoration = @"CHTCollectionElementKindSectionDecoration";
...
@interface CHTWaterDecorationCollectionReusableView : UICollectionReusableView

@end

@implementation CHTWaterDecorationCollectionReusableView
...
- (void)prepareLayout {
    ...
    [self registerClass:[CHTWaterDecorationCollectionReusableView class] forDecorationViewOfKind:CHTCollectionElementKindSectionDecoration];
    ...
    for (NSInteger section = 0; section < numberOfSections; ++section) {
        ...
        //修饰视图的高度
        CGFloat decorationHeight = top - lastTop;
        /*
         Decoration
         */
        
        if ([self.delegate respondsToSelector:@selector(collectionView:layout:backgroundColorForSection:)]) {
            UIColor *bgColor = [self.delegate collectionView:self.collectionView layout:self backgroundColorForSection:section];
            CHTCollectionViewLayoutAttributes *attr =
            [CHTCollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:CHTCollectionElementKindSectionDecoration
                                                                         withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
            CGFloat attrY =  lastTop;
            attr.frame = CGRectMake(0,
                                    attrY,
            ...
            self.decorationAttribute[@(section)] = attr;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    } else if ([kind isEqualToString:CHTCollectionElementKindSectionDecoration]) {
        attribute = self.decorationAttribute[@(indexPath.section)];
    }
    return attribute;
}
